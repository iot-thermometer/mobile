...
internal class AdvertisementSelectionUseCase
    @Inject
    constructor(
        ...
        fun getSelectedAdvertisement(): StateFlow<BluetoothDeviceAdvertisement?> = addDeviceRepository.getSelectedAdvertisement()
    }
